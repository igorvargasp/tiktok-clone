      ...
      <UploadLayout>
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
          <div>
            ...
            <h2 className="text-gray-400 mt-1">Post a video yo your account</h2>
          </div>
            ...
            <div className="mt-4 mb-6">
              <div className="flex bg-[#F8F8F8] py-4 px-6">
                ...
                <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                  <button className="px-8 py-1.5 text-white bg-[#F02C56] rounded-sm">
                    Edit
                  </button>
                </div>
              </div>
              <div className="mt-5">
                <div className="flex items-c justify-between">
