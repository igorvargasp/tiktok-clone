    ...
    <>
      <div id={`PostMain-${post.id}`} className="flex border-b py-6">
        ...
        <div className="pl-3 w-full px-4">
          ...
          <p className="text-[14px] text-gray-500 pb-0.5 flex items-center font-semibold">
            <ImMusic size="17" />
            <span className="px-1">original sound - AWESOME</span>
            <AiFillHeart size="20" />
          </p>
          <div className="mt-2.5 flex">
            <div className="relative min-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
              <video
                id={`video-${post.id}`}
                loop
                controls
