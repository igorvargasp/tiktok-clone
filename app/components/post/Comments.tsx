...
export default function Comments({ params }: CommentsCompTypes) {
  ...
  return (
    <>
      <div
        id="Comments"
        className="relative bg-[#F8F8F8F8] z-0 w-full h-[calc(100%-273px)] border-t-2 overflow-auto"
      >
        <div className="pt-2" />
        <ClientOnly>
      ...
      <div
        className="absolute flex items-center justify-between bottom-0 bg-white h-[85px] lg:max-[550px] w-full py-5 px-8 border-t-2"
        id="CreateComment"
      >
        <div
